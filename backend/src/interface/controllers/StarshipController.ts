...
export class StarshipController {
    ...
    constructor(getStarshipUseCase: GetStarships, getStarshipByNameUseCase: GetStarshipByName) {
    ...
    async getStarships(req: Request, res: Response) {
        try {
            ...
            const starships = await this.getStarshipsUseCase.execute(filters, options);

...
const planetController = new PlanetController(getPlanetsUseCase, getPlanetByNameUseCase);

const planetRoutes = Router();

planetRoutes.get('/', (req, res) => planetController.getPlanets(req, res));

planetRoutes.get('/:name', (req, res) => planetController.getPlanetByName(req, res));
